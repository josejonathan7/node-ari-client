...
class Asterisk extends Resource {
  ...
  constructor(client, objValues) {
    super(client, undefined, objValues);
  }
}
...
class Endpoint extends Resource {
  ...
  constructor (client, id, objValues) {
    super(client, id, objValues);
    console.log("no endpoint: ", this.attachOperation);
 ...
 */
const application = (client, id, objValues) => {
 ...
 */
const asterisk = (client, objValues) => {
 ...
 */
const bridge = (client, id, objValues) => {
 ...
 */
const channel = (client, id, objValues) => {
 ...
 */
const deviceState = (client, id, objValues) => {
 ...
 */
const endpoint = (client, id, objValues) => {
  const endpoint = new Endpoint(client, id, objValues);
  Object.assign(endpoint, AttachOperations.prototype);
 ...
 */
const liveRecording = (client, id, objValues) => {
 ...
 */
const mailbox = (client, id, objValues) => {
 ...
 */
const playback = (client, id, objValues) => {
 ...
 */
const sound = (client, id, objValues) => {
...
const storedRecording = (client, id, objValues) => {
